...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-ha7yh5xghxm&i_#ie8)$56k0u1x04jjc#(o5)iecp(bjupq3k=')
...
INSTALLED_APPS = [
    ...
    'bit_mailer',  # Add your app here
    'corsheaders',  # CORS headers for cross-origin requests, if needed
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'bit_mailer'), 
